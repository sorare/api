...
* `transfer` allows Sorare to move funds between accounts within the Bank. It requires a cryptographic signature from the payer. You can see how signatures are produced in [baseBankTransfer.js](../examples/baseBankTransfer.js) and [solanaBankTransfer.js](../examples/solanaBankTransfer.js). Solana signatures use the key pair derived in [solanaKeyPair.js](../examples/solanaKeyPair.js)
